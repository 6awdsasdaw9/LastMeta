...
namespace Code.Character
{
    public class CharacterJuice : MonoBehaviour
    {
        ...
        void Start()
        {
            moveScript = GetComponent<HeroMovement>();
            jumpScript = GetComponent<HeroJump>();
        }
        ...
        void Update()
        {
            ...
            runningSpeed = Mathf.Clamp(Mathf.Abs(moveScript.GetVelocity().x), 0, maxSpeed);
        ...
        private void tiltCharacter()
        {
            ...
            if (moveScript.GetVelocity().x != 0)
            {
                directionToTilt = Mathf.Sign(moveScript.GetVelocity().x);
            }
