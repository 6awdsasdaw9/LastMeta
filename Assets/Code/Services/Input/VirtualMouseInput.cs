...
namespace Code.Services.Input
{
    ...
    public class VirtualMouseInput : MonoBehaviour
    {
        ...
        [Header("Motion")] [SerializeField] private float m_CursorSpeed = 400;
        ...
        private static void SetActionCallback(InputActionProperty field, Action<InputAction.CallbackContext> callback,
            bool install = true)
        {
